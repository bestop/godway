...
export const SKILLS: Skill[] = [
  ...
  },
  {
    id: 'skill_iron_skin',
    name: '铁壁',
    description: '提升100%防御，持续3回合',
    icon: '🛡️',
    type: 'buff',
    target: 'self',
    mpCost: 15,
    cooldown: 5,
    effect: { buffDef: 1.0, duration: 3 },
    requiredRealm: '筑基期',
    unlockLevel: 2
  },
  {
  ...
  },
  {
    ...
    name: '破甲',
    description: '降低敌人60%防御，持续3回合',
    icon: '🔨',
    type: 'debuff',
    target: 'enemy',
    mpCost: 20,
    cooldown: 4,
    effect: { debuffDef: 0.6, duration: 3 },
    requiredRealm: '金丹期',
    unlockLevel: 5
  },
  {
    ...
    name: '灵力爆发',
    description: '释放全部灵力，造成1000%攻击力伤害',
    icon: '💫',
    type: 'special',
    target: 'enemy',
    mpCost: 50,
  ...
  },
  {
    id: 'skill_life_steal',
    name: '吸血术',
    description: '造成400%攻击力伤害，并恢复等量气血',
    icon: '🩸',
    type: 'special',
    target: 'enemy',
    mpCost: 30,
    cooldown: 4,
    effect: { damageMultiplier: 4.0, healMultiplier: 1.0 },
    requiredRealm: '元婴期',
    unlockLevel: 3
  },
  {
    ...
    name: '神盾',
    description: '提升200%防御，持续5回合',
    icon: '✨',
    type: 'buff',
    target: 'self',
    mpCost: 40,
    cooldown: 8,
    effect: { buffDef: 2.0, duration: 5 },
    requiredRealm: '元婴期',
    unlockLevel: 5
  },
  {
    ...
    name: '天雷灭世',
    description: '召唤天雷，造成1500%攻击力伤害',
    icon: '🌩️',
    type: 'attack',
    target: 'enemy',
    mpCost: 80,
    cooldown: 8,
    effect: { damageMultiplier: 15.0 },
    requiredRealm: '化神期',
    unlockLevel: 1
  },
  {
    ...
    name: '不灭金身',
    description: '恢复200%最大气血',
    icon: '🌟',
    type: 'heal',
    target: 'self',
    mpCost: 60,
    cooldown: 10,
    effect: { healMultiplier: 2.0 },
    requiredRealm: '化神期',
    unlockLevel: 3
  },
  {
    ...
    name: '灭世一击',
    description: '毁天灭地的一击，造成2500%攻击力伤害',
    icon: '💥',
    type: 'special',
    target: 'enemy',
    mpCost: 100,
    cooldown: 10,
    effect: { damageMultiplier: 25.0 },
    requiredRealm: '合体期',
    unlockLevel: 1
  },
  {
  ...
  },
  {
    ...
    name: '天道之力',
    description: '召唤天道之力，造成5000%攻击力伤害',
    icon: '👑',
    type: 'special',
    target: 'enemy',
    mpCost: 150,
    cooldown: 15,
    effect: { damageMultiplier: 50.0 },
    requiredRealm: '大乘期',
    unlockLevel: 1
  }
];
